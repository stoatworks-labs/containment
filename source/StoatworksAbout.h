...
namespace stoatworks::about
{
    ...
    inline constexpr auto hook = "A plasma ball in a magnetic bottle, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/containment/guide/";
