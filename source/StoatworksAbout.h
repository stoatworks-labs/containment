/*
 * Stoatworks Labs - About window data for containment.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Containment is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only containment
 ...
 * five, and Containment.cpp static_asserts the run so the change cannot land
 * silently.
 */
#pragma once
...
{
    inline constexpr auto name = "containment";
    inline constexpr auto slug = "containment";
    inline constexpr auto hook = "A ball of plasma in a magnetic bottle, for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "";
    inline constexpr auto page = "https://stoatworks-labs.com/software/containment/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/containment";
