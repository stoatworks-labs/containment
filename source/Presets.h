...
inline constexpr Preset kPresets[] = {
	{ "Clip Orb",             { 0.389f, 0.315f, 0, 0.1f, 0.0f, 0.15f, 0.25f, 0.7f, 2, 0.105f, 0.55f, 0.316f, 0, 1, 0, 0, 0.274f, 0.442f, 0.4167f, 0.0f, 0, 0.333f, 0.0f, 0.273f } },
	...
	//where the edge stays smooth, in a Wall (the cheaper bottle: see
	//AGENTS.md), fuelled so it never runs down. The clip keeps its own
	//colours.

	{ "Green Orb",            { 0.389f, 0.315f, 0, 0.1f, 0.0f, 0.15f, 0.25f, 0.7f, 2, 0.105f, 0.62f, 0.36f, 0, 1, 0, 0, 0.33f, 0.4f, 0.45f, 0.9f, 1, 0.62f, 0.35f, 0.25f } },
	...
	{ "Guide Field Bubble",   { 0.306f, 0.4f, 1, 0.1f, 0.0f, 0.0f, 0.5f, 0.5f, 0, 0.105f, 0.5f, 0.0f, 0, 1, 0, 0, 0.0f, 0.442f, 0.4167f, 0.5f, 0, 0.4f, 0.0f, 0.273f } },
	...
	//and the fuel keeps it squirting. Open, so what leaks leaves.

	{ "Rayleigh-Taylor",      { 0.389f, 0.315f, 1, 0.1f, 0.0f, 0.15f, 0.25f, 0.7f, 0, 0.105f, 0.5f, 0.7f, 0, 1, 0, 0, 0.1f, 0.442f, 0.4167f, 0.3f, 0, 0.4f, 0.0f, 0.273f } },
	...
	//front `cttest --quench` checks against the exact Riemann solution. Open,
	//so the fireball leaves the frame.
